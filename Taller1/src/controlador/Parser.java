...
public abstract class Parser
{
    ...
    public static void parse(String raw_command) throws Exception
    {
        ...
        if(raw_command == null)
            throw new Exception("Error 000: Se ha introducido un comando vacÌo");
        ...
        if(split_command[0].equals("CREAR"))
        {
            ...
            if(fileExists(split_command[1]))
                throw new Exception("Error 004: OperaciÛn no realizable. (Ya existe el archivo)");
        ...
        else if(split_command[0].equals("CARGAR"))
        {
            ...
            {
                throw new Exception("Error 004: OperaciÛn no realizable. (El archivo existe, pero no contiene un almacÈn)");
            }
        ...
        else if(split_command[0].equals("GUARDAR"))
        {
            ...
            if(!Sistema.getInstance().tieneAlmacenCargado())
                throw new Exception("Error 004: OperaciÛn no realizable. (No hay almac√©n cargado)");
        ...
        else if(split_command[0].equals("CONSULTAR")) 
        {
            ...
            throw new Exception("Error 001: No se reconoce la instrucci√≥n \""+split_command[0]+"\"");
    }
